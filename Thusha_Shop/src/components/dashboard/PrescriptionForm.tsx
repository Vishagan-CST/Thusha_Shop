...
interface PrescriptionFormProps {
  ...
  onEyeValueChange: (eye: 'rightEye' | 'leftEye', field: keyof EyePrescription, value: number) => void;
  onSave: () => Promise<void> | void;  // support async save function
  onCancel: () => void;
  onPupillaryDistanceChange: (value: number) => void;
  onSuccess?: () => void; // optional callback to trigger refetch after save
}
...
const PrescriptionForm = ({
  ...
  // Wrapper to handle async save and call onSuccess
          ...
          <div className="grid gap-4">
                ...
                <div className="grid grid-cols-3 gap-2">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        onEyeValueChange('rightEye', 'sphere', parseFloat(e.target.value) || 0)
                      }
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        onEyeValueChange('rightEye', 'cylinder', parseFloat(e.target.value) || 0)
                      }
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        onEyeValueChange('rightEye', 'axis', parseInt(e.target.value) || 0)
                      }
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-2">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        onEyeValueChange('leftEye', 'sphere', parseFloat(e.target.value) || 0)
                      }
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        onEyeValueChange('leftEye', 'cylinder', parseFloat(e.target.value) || 0)
                      }
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        onEyeValueChange('leftEye', 'axis', parseInt(e.target.value) || 0)
                      }
                    />
                  </div>
                </div>
            ...
            <div className="grid gap-2">
              ...
              <Input
                ...
                onChange={(e) => onPupillaryDistanceChange(parseInt(e.target.value) || 0)}
              />
            </div>
